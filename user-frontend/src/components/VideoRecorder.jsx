...
const VideoRecorder = ({ interviewID, userId, uploadVideo }) => {
  ...
  const startRecording = async () => {
    ...
    mediaRecorderRef.current.onstop = () => {
      ...
      chunks.current = [];
      uploadVideo(blob, interviewID, userId); // interviewId ve userId'yi kullanarak yükleme yap
    };
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-6 mb-4">
        <video
          ...
          autoPlay
          muted
          className="w-full h-48 rounded-lg mb-4 border-2 border-gray-300"
        />
